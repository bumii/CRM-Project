...
namespace MatriksCRM.Views.Home
{
    public class DBConnection
    {
        public SqlConnection connection = null;
        public string connectionString = @"Data Source=192.168.100.35;Initial Catalog=MatriksCRMStaj;User ID=stajyer;Password=stajyer;";
